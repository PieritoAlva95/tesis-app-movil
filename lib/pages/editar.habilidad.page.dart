        ...
        buttons: [
          DialogButton(
            onPressed: () async{
              ...
              skillsParaWidget.add(_nombreHabilidadController.text.toString());
        ...
        mainAxisAlignment: MainAxisAlignment.start,
          children: user.skills
              .map((item) => Column(
                    children: [
                       ListTile(
                         title: Text(item,style: TextStyle(fontSize: 20.0, color: Color.fromRGBO(29, 53, 87, 1.0), fontWeight: FontWeight.bold),),
                         trailing: InkWell(
                              onTap: () async{

                                skillsParaWidget.removeWhere((element) => (element == item));
