                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text('Regístrate!', 
                        style: TextStyle(fontSize: 30.0, color: Color.fromRGBO(255, 255, 255, 1), fontWeight: FontWeight.bold),
                        ),
                      ...
                      FlatButton(
                        child: Text('¿Ya tienes una cuenta?', style: TextStyle(color: Colors.white)),
    ...
    return StreamBuilder(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          icon: Icon(Icons.person, color: Color.fromRGBO(53, 80, 112, 1.0),),
  ...
  Widget _crearCedula(RegistroBloc bloc) {
    return StreamBuilder(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          icon: Icon(Icons.perm_identity, color: Color.fromRGBO(53, 80, 112, 1.0),),
  ...
  Widget _crearTelefono(RegistroBloc bloc) {
    return StreamBuilder(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          icon: Icon(Icons.phone, color: Color.fromRGBO(53, 80, 112, 1.0),),
  ...
  Widget _crearEmail(RegistroBloc bloc) {
    return StreamBuilder(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          icon: Icon(Icons.alternate_email, color: Color.fromRGBO(53, 80, 112, 1.0),),
    ...
    Widget _crearPassword(RegistroBloc bloc) {
      ...
      child: TextField(
        obscureText: true,
        decoration: InputDecoration(
          icon: Icon(Icons.lock_outline, color: Color.fromRGBO(53, 80, 112, 1.0),),
      ...
      stream: bloc.formValidStream,
       builder: (BuildContext context, AsyncSnapshot snapshot){
         ...
         return RaisedButton(
          ...
          onPressed: snapshot.hasData? ()=> _registroUsuario(bloc, context): null,
        );
