...
@override
              ...
              FutureBuilder(
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasData && snapshot.data!['oferta'] != null) {
                    ...
                    oferta.nombreUsuario =snapshot.data!['oferta']['nombreUsuario'];
                        ...
                        Row(
                          ...
                          children: [
                            FlatButton(
                              ...
                              //oferta.interesados = [];
                              print(preferencias.idUsuario.toString());
                              ...
                              final map = {
                                ...
                                'postulante': dataUsuarioPostulante['usuario']['uid'],
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(' Postular', style: TextStyle(color: Colors.white),),
                                ],
                              ),
                            ),
                            FlatButton(
 ...
 _usuarioObtenidoArrendador() {
    return FutureBuilder(
        future:
            usuarioBloc.cargarUsuarioEspecifico(preferencias.idUsuario),
        builder: (BuildContext context,
            AsyncSnapshot<Map<String, dynamic>> snapshot) {
...
_autorDeLaPublicacion(){
  return InkWell(
    onTap: (){
      print(oferta.usuario);
      Navigator.pushNamed(context, 'verperfil',
      arguments: {oferta.usuario});
    },
    child: Row(
      children: [
