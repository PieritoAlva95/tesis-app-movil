...
class HomeFiltrosPage extends StatefulWidget {
  const HomeFiltrosPage({Key? key}) : super(key: key);
...
class _HomeFiltrosPageState extends State<HomeFiltrosPage> {
  ...
  _crearBotonVisualizar(
    ...
    return ElevatedButton(
      onPressed: () async {
        ...
        if (!ofertaNueva.interesados.toString().contains(
  ...
  _filtrarDatosNoLogueado() async {
    final response = await http.get(
      Uri.parse('$URLBASE/api/oferta/busqueda/categoria/$_categoriaString'),
