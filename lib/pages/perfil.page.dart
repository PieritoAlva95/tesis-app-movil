...
class _PerfilPageState extends State<PerfilPage> {
  ...
  final Usuario usuario = new Usuario(
      skills: [], experiencia: [], estudios: [], fechaCreacion: DateTime.now(), redesSociales: RedesSociales());
    ...
    return Scaffold(
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              FutureBuilder(
                future: idObtenido.toString().isEmpty? perfilBloc.cargarUsuario(): perfilBloc.cargarUsuarioEspecifico(idObtenido.toString()),
                builder: (BuildContext context,
                    AsyncSnapshot<Map<String, dynamic>> snapshot) {
                  //print('usuaioDB: ${snapshot.data}');
                  ...
                  if (snapshot.hasData && snapshot.data!['usuario'] != null) {
                    ...
                    usuario.numeroDeCelular = snapshot.data!['usuario']['numeroDeCelular'];
                    usuario.experiencia = snapshot.data!['usuario']['experiencia'];
                    ...
                    return Column(
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              CircleAvatar(
                                radius: 80.0,
                                backgroundImage: usuario.img != null? NetworkImage(_url+usuario.img): NetworkImage(urlPhotoUserNotFound),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  usuario.nombres.toString() +' ' +usuario.apellidos.toString(),textAlign: TextAlign.center,
                              ...
                              InkWell(
                                onTap: (){
                                  print(usuario.numeroDeCelular.toString());
                                  if(usuario.numeroDeCelular.toString().length>0){
                                      launchWhatsApp(
                                      phone: int.parse('+593'+usuario.numeroDeCelular),
                              ...
                              Container(
                                ...
                                height: 10.0,
                                    ...
                                    Column(
                                      children: [
                                        Text(usuario.bio, style: TextStyle(fontSize: 12.0, color: Colors.white), textAlign: TextAlign.justify),
                                      ],
                                    ),
                        ...
                        decoration: BoxDecoration(
                        border: Border.all(color: Color.fromRGBO(29, 53, 87, 1.0), width: 2.0),
                        borderRadius: BorderRadius.all(Radius.circular(8.0)),
                         ),
                          child: Column(
                            children: [
                              Text('Experiencia', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Color.fromRGBO(29, 53, 87, 1.0),),),
                        ...
                        borderRadius: BorderRadius.all(Radius.circular(8.0)),
                          ...
                          child: Column(
                            children: [
                              Text('Estudios', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: Color.fromRGBO(29, 53, 87, 1.0),),),
                              _recorrerEstudios(),
                            ],
                          ),
                        ),
            ...
            .map<Widget>((experiencia) =>
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: 5.0,),
                    Text(experiencia['fechaInicio']+' | '+experiencia['fechaFin'], style: TextStyle(fontSize: 11.0),),
                    SizedBox(height: 5.0,),
                    Text(experiencia['empresa'], style: TextStyle(fontSize: 11.0, fontWeight: FontWeight.bold),),
                    SizedBox(height: 5.0,),
                    Text(experiencia['descripcion'], style: TextStyle(fontSize: 11.0), textAlign: TextAlign.justify,),
                    Divider(),
                  ],
                )
                )
            ...
            .map<Widget>((experiencia) =>
                ...
                Column(
                  children: [
                    ...
                    Text(experiencia['fechaInicio']+' | '+experiencia['fechaFin'], style: TextStyle(fontSize: 11.0),),
                    SizedBox(height: 5.0,),
                    Text(experiencia['nombreInstitucion'], style: TextStyle(fontSize: 11.0, fontWeight: FontWeight.bold),),
                    SizedBox(height: 5.0,),
                    Text(experiencia['descripcion'], style: TextStyle(fontSize: 11.0), textAlign: TextAlign.justify,),
                    Divider(),
                  ],
